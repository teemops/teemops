...
terraform destroy -var-file=../../env/migrations/s3.tfvars  -var="source_bucket_name=$SOURCE_BUCKET_NAME" -var "dest_bucket_arn=arn:aws:s3:::$DEST_BUCKET_NAME"  -auto-approve
...
terraform workspace select prod
terraform destroy -var-file=../../env/migrations/s3.tfvars  -var="dest_bucket_name=$DEST_BUCKET_NAME" -var="source_account_id=$SOURCE_ACCOUNT_ID" -auto-approve
